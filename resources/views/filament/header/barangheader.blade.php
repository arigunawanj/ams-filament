...
<body>
    <div class="grid grid-cols-1 gap-3">
        <h2 class="font-bold text-2xl">Kelola Barang</h2>
        <a href="{{ route('filament.resources.barangs.create') }}"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Masukkan File yang akan di
                            import</h3>
                        <form class="space-y-6" action="{{ route('importbarang') }}" method="POST"
