...
<body>
    <div class="grid grid-cols-1 gap-3">
        ...
        <a href="{{ route('filament.resources.satuans.create') }}" class="col-start-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-orange-600 dark:hover:bg-orange-700 focus:outline-none dark:focus:ring-orange-800">Buat</a>
