...
<body>
    <div class="grid grid-cols-1 gap-3">
        <h2 class="font-bold text-2xl">Kelola Customer</h2>
        <a href="{{ route('filament.resources.customers.create') }}"
            class="col-start-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-orange-600 dark:hover:bg-orange-700 focus:outline-none dark:focus:ring-orange-800">Buat</a>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Masukkan File yang akan di
                            import</h3>
                        <form class="space-y-6" action="{{ route('importcustomer') }}" method="POST"
